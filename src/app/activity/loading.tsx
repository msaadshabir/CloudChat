    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="flex-1 flex flex-col ml-[260px]">
        ...
        <div className="flex-1 max-w-2xl mx-auto px-6 py-10 mt-6 w-full">
          ...
          {/* Likes received section skeleton */}
          <section className="mb-8">
            <div className="h-4 w-36 bg-gray-800 rounded mb-3" />
            <div className="space-y-4">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="vercel-card p-6 rounded-[10px] flex items-start gap-4 animate-pulse">
          ...
          {/* Your likes section skeleton */}
          <section>
            <div className="h-4 w-28 bg-gray-800 rounded mb-3" />
            <div className="space-y-4">
              {Array.from({ length: 2 }).map((_, i) => (
                <div key={i} className="vercel-card p-6 rounded-[10px] animate-pulse">
